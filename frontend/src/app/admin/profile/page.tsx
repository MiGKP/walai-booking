...
import { User, Mail, Phone, Save, Lock, ShieldCheck, MessageSquare, Facebook, MapPin } from 'lucide-react';
        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-lg font-bold text-[#133E31]">
              {user.first_name || 'ผู้ใช้แอดมิน'} {user.last_name}
            </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-4 items-start">
        ...
        <div className="bg-white rounded-2xl p-4 md:p-5 border border-stone-200/80 shadow-sm">
          <div className="flex items-center gap-2 pb-2.5 mb-3 border-b border-stone-100">
            ...
            <h2 className="text-base font-bold text-[#133E31]">ข้อมูลส่วนตัว</h2>
          </div>

          <form onSubmit={handleSaveProfile} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm font-semibold text-stone-700 mb-1">ชื่อ</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-700 mb-1">นามสกุล</label>
                <input
                  type="text"
                  required
                  className="w-full px-3 py-2 rounded-xl border border-stone-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#133E31]/20 focus:border-[#133E31] transition-all bg-stone-50/30"
            ...
            <div>
              <label className="block text-sm font-semibold text-stone-700 mb-1">อีเมลผู้ดูแลระบบ</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm font-semibold text-stone-700 mb-1">LINE ID</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-700 mb-1">Facebook</label>
                <div className="relative">
                  <Facebook size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400" />
                  <input
                    type="text"
                    className="w-full pl-9 pr-3 py-2 rounded-xl border border-stone-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#133E31]/20 focus:border-[#133E31] transition-all bg-stone-50/30"
            ...
            <div>
              <label className="block text-sm font-semibold text-stone-700 mb-1">ที่อยู่</label>
              <div className="relative">
                <MapPin size={16} className="absolute left-3 top-2.5 text-stone-400" />
                <textarea
                  rows={2}
        ...
        <div className="bg-white rounded-2xl p-4 md:p-5 border border-stone-200/80 shadow-sm">
          <div className="flex items-center gap-2 pb-2.5 mb-3 border-b border-stone-100">
            ...
            <h2 className="text-base font-bold text-[#133E31]">เปลี่ยนรหัสผ่าน</h2>
          </div>

          <form onSubmit={handleChangePassword} className="space-y-3">
            <div>
              <label className="block text-sm font-semibold text-stone-700 mb-1">รหัสผ่านปัจจุบัน</label>
              <input
                type="password"
                required
                className="w-full px-3 py-2 rounded-xl border border-stone-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#133E31]/20 focus:border-[#133E31] transition-all bg-stone-50/30"
            ...
            <div>
              <label className="block text-sm font-semibold text-stone-700 mb-1">รหัสผ่านใหม่</label>
              <input
                type="password"
                required
                minLength={6}
            ...
            <div>
              <label className="block text-sm font-semibold text-stone-700 mb-1">ยืนยันรหัสผ่านใหม่</label>
              <input
                type="password"
                required
                minLength={6}
