...
export default function BoatLocationPage() {
  ...
  // ถอดค่าเวลาเปิด-ปิดจาก operating_hours (ค่าเริ่มต้น 09:00 น. - 18:00 น.)
  const startTime = form.operating_hours?.split(" - ")[0] || "09:00 น.";
  const endTime = form.operating_hours?.split(" - ")[1] || "18:00 น.";
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch((err) => {
        console.error(err);
        toast.error("โหลดข้อมูลจุดบริการเรือไม่สำเร็จ");
      })
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start w-full">
            ...
            <div className="p-5 md:p-6 bg-white rounded-2xl border border-stone-200/80 shadow-2xs space-y-4">
              <div className="flex items-center gap-2 text-[#064e3b] font-bold text-sm pb-3 border-b border-stone-100">
                ...
                <h2 className="text-base font-bold">
                  ข้อมูลติดต่อจุดบริการเรือ (Boat Service Counter)
                </h2>
              </div>
              ...
              <div className="space-y-4 pt-1">
                <div>
                  ...
                  <input
                    ...
                    placeholder="เช่น จุดบริการลงเรือ / ท่าเรือวิจัย"
                  />
                </div>
            ...
            <div className="p-5 md:p-6 bg-white rounded-2xl border border-stone-200/80 shadow-2xs space-y-4">
              <div className="flex items-center gap-2 text-[#064e3b] font-bold text-sm pb-3 border-b border-stone-100">
                ...
                <h2 className="text-base font-bold">
                  ตำแหน่งจุดขึ้นเรือ / ท่าเรือ (Location)
                </h2>
              </div>
              ...
              <div className="space-y-4 pt-1">
                <div>
                  <label className="block text-xs font-semibold text-stone-700 mb-1.5">
                    คำอธิบายที่อยู่/จุดสังเกตขึ้นเรือ
                  </label>
                  <textarea
                    rows={3}
                    ...
                    placeholder="รายละเอียดจุดสังเกตอาคารหรือเคาน์เตอร์บริการเรือ..."
                  />
                </div>
          ...
          <div className="bg-white rounded-3xl max-w-sm w-full p-6 shadow-2xl border border-stone-100 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1.5 leading-relaxed">
                คุณต้องการบันทึกการเปลี่ยนแปลงข้อมูลจุดบริการเรือและท่าเรือใช่หรือไม่คะ
              </p>
            </div>
